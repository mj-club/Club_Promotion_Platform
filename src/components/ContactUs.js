...
import { Paper, makeStyles, Grid, IconButton } from "@material-ui/core";
...
const ContactUs = ({ contactus }) => {
  ...
  const instargramUrl = `https://www.instagram.com/${contactus.instargram}/`;
  return (
    <Grid container spacing={3} justify="center">
      <Grid item>
        <IconButton href={contactus.facebook}>
          <img
            width="50px"
      ...
      <Grid item>
        <IconButton href={contactus.openchat}>
          <img
            width="50px"
